...
class VideoDB(object):
    ...
    def __init__(self, path=None):
        ...
        if path is None:
            ...
            elif xbmc.__version__ == '2.20.0':
                path = 'special://profile/Database/MyVideos93.db'
            elif xbmc.__version__ == '2.24.0':
                path = 'special://profile/Database/MyVideos99.db'
            elif xbmc.__version__ == '2.25.0':
                path = 'special://profile/Database/MyVideos107.db'
            elif xbmc.__version__ == '2.26.0':
                path = 'special://profile/Database/MyVideos116.db'
            else:
